...
var ValidaCPF = /*#__PURE__*/function () {
  function ValidaCPF(cpfEnviado) {
    ...
    Object.defineProperty(this, "cpfLimpo", (_Object$definePropert = {
      writable: false,
      enumerable: false
    }, _defineProperty(_Object$definePropert, "enumerable", false), _defineProperty(_Object$definePropert, "value", cpfEnviado.replace(/\D+/g, "")), _Object$definePropert));
  }
  _createClass(ValidaCPF, [{
    ...
    value: function valida() {
      if (!this.cpfLimpo || typeof this.cpfLimpo !== "string" || this.cpfLimpo.length !== 11 || this.isSequence()) return false;
      this.geraNovoCPF();
